...
export const translations: Record<SupportedLanguage, TranslationsSchema> = {
  ar: {
    ...
    contribute: {
      ...
      detailedTitle: 'إضافة مصدر دراسي محدد',
      detailedSubtitle: 'أدخل رابط المصدر مع إمكانية تحديد الموديول والمادة.',
      urlLabel: 'رابط المصدر أو الدرايف (URL)',
      urlPlaceholder: 'https://drive.google.com/... أو https://t.me/... أو youtube.com/...',
      titleLabel: 'عنوان المصدر',
      optional: '(اختياري)',
      titlePlaceholder: 'مثال: مذكرات د. شيرين في موديول Blood أو درايف الدفعة',
      doctorLabel: 'إعداد',
      doctorHint: '(اسم الدكتور / المحاضر)',
      doctorPlaceholder: 'مثال: د. شيرين، د. ناجي',
      contributorLabel: 'أضافها',
      contributorHint: '(اسمك للشكر والتوثيق)',
      contributorPlaceholder: 'اسمك لحفظ حقك في المشاركة',
      yearLabel: 'السنة الدراسية',
      yearGeneral: 'عام / غير محدد',
      moduleLabel: 'الموديول',
      moduleGeneral: 'عام / كل السنة',
      typeLabel: 'نوع المصدر',
      submitBtn: 'إرسال المصدر',
      sendingBtn: 'جاري الإرسال...',
      successTitle: 'تم استلام المصدر بنجاح!',
      successDesc: 'شكراً لمساهمتك! سيتم مراجعة الرابط وإدراجه في الموديول المخصص قريباً.',
      submitAnother: 'إرسال مصدر آخر',
      dumpTitle: 'تفريغ سريع للمصادر',
      dumpBadge: 'الأسرع',
      dumpSample: 'تجربة بنموذج',
      dumpClear: 'مسح',
      dumpTextareaLabel: 'النص أو الروابط المجمعة',
      dumpPlaceholder: 'الصق هنا رسالة الواتساب، أو رابطاً مع وصف بسيط، أو قائمة مذكرات ودرايفات...',
      dumpContributorLabel: 'اسمك أو فريق العمل',
      dumpContributorHint: '(اختياري - لحفظ حق الإعداد)',
      dumpContributorPlaceholder: 'مثال: د. أحمد سامح (أو اتركه فارغاً إذا كنت تفضل فاعل خير)',
      dumpSubmitBtn: 'إرسال وتفريغ المصادر',
      dumpSuccessTitle: 'تم استلام المصادر بنجاح!',
      dumpSuccessDesc: 'شكراً لمساهمتك لدعم زملائك! سيقوم المشرف بمراجعة الروابط وتنسيقها وإدراجها بالموقع تباعاً.',
      dumpSubmitAnother: 'إرسال دفعة مصادر أخرى'
    },
    contributors: {
      breadcrumbHome: 'الرئيسية',
  ...
  en: {
    ...
    contribute: {
      ...
      detailedTitle: 'Submit a Specific Resource',
      detailedSubtitle: 'Enter resource link with optional module and subject classification.',
      urlLabel: 'Resource or Drive Link (URL)',
      urlPlaceholder: 'https://drive.google.com/... or https://t.me/... or youtube.com/...',
      titleLabel: 'Resource Title',
      optional: '(Optional)',
      titlePlaceholder: 'e.g. Dr. Shireen notes for Blood module or Batch drive',
      doctorLabel: 'Prepared by',
      doctorHint: '(Doctor / Lecturer name)',
      doctorPlaceholder: 'e.g. Dr. Shireen, Dr. Nagi',
      contributorLabel: 'Added by',
      contributorHint: '(Your name for attribution)',
      contributorPlaceholder: 'Your name for credit',
      yearLabel: 'Academic Year',
      yearGeneral: 'General / Unspecified',
      moduleLabel: 'Module',
      moduleGeneral: 'General / Full Year',
      typeLabel: 'Resource Type',
      submitBtn: 'Submit Resource',
      sendingBtn: 'Submitting...',
      successTitle: 'Resource Received Successfully!',
      successDesc: 'Thank you for your contribution! The link will be reviewed and listed soon.',
      submitAnother: 'Submit Another Resource',
      dumpTitle: 'Quick Multi-Link Dump',
      dumpBadge: 'Fastest',
      dumpSample: 'Try with sample',
      dumpClear: 'Clear',
      dumpTextareaLabel: 'Bulk Text or Links',
      dumpPlaceholder: 'Paste WhatsApp messages, links with short descriptions, or lists of drives and notes...',
      dumpContributorLabel: 'Your Name or Team',
      dumpContributorHint: '(Optional - for credit)',
      dumpContributorPlaceholder: 'e.g. Ahmed Sameh (or leave empty)',
      dumpSubmitBtn: 'Send & Process Links',
      dumpSuccessTitle: 'Resources Received Successfully!',
      dumpSuccessDesc: 'Thank you for helping your colleagues! The links will be reviewed and formatted for the site.',
      dumpSubmitAnother: 'Send Another Batch'
    },
    contributors: {
      breadcrumbHome: 'Home',
